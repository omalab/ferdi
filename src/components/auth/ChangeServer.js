  ...
  form = new Form({
    fields: {
      server: {
        ...
        options: [{ value: this.ferdiServer, label: 'Engage Dock' }, { value: this.franzServer, label: 'Franz' }, { value: this.defaultServers.includes(this.props.server) ? '' : this.props.server, label: 'Custom' }],
      },
      customServer: {
