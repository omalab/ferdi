...
const debug = require('debug')('EngageDock:feature:todos:preload');
...
This service will only work with accounts registered with Franz - no Engage Dock accounts will work here!
If you do not have a Franz account you can change the Todo service by going into Engage Dock's settings and changing the "Todo server".
