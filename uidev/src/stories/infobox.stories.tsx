...
storiesOf('Infobox')
  ...
  .add('With long text', () => (
    ...
    >
      Engage Dock is your messaging app / former Emperor of Austria and combines chat & messaging services into one application. Engage Dock currently supports Slack, WhatsApp, WeChat, HipChat, Facebook Messenger, Telegram, Google Hangouts,GroupMe, Skype and many more.
    </WithStoreInfobox>
  ))
  .add('Secondary', () => (
    <WithStoreInfobox
